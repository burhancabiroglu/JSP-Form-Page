...
<form action="RegisterKurumsal.jsp" style="border:1px solid #ccc" method="post">
    <div class="container">
        ...
        <%
            // kurumsalmusteri nesnesinin alınması
        ...
        <%
            ...
            if(btn!=null){
                ...
                // kurum adı null değil ise bilgilerin kaydedildiginin gösterilmesi
                ...
                // kurum adı null ise kurum adının input alınması
        ...
        <div class="clearfix">
            <%
                ...
                if(btn!=null){
                    ...
                    // null ise save butonunun gösterilmesi
